<?php
	...
	if(isset($_SESSION['username']))
    {
    	...
    	if($_SERVER['REQUEST_METHOD'] == 'POST')
	    {
	    	...
	    	if(!empty($row1))
            {
            $msg[] = "<div class='alert alert-danger' dir='rtl'> أنت قدمت طلب اشتراك بالفعل من قبل سيتم البت فى طلب الاشتراك قريبا.</div>";
            }
             else{
               ...
               $success = "<div class='alert alert-success' dir='rtl'>تم تقديم طلب اشتراك بنجاح</div>";
            }  
	    }
    }
    else
...
margin-bottom: 30px;" href="index.php">الرئيسيه</a>
    ...
    padding-right: 300px;" href="#">المياه</a>
  <ul class="navbar-nav">
    <li class="nav-item">
...
<div class="form-v5">
  ...
  <div id="footer_contact" style="text-align: center; text-decoration: none; background-color: black; height: 130px;">
