...
<nav class="w3-sidebar  w3-collapse w3-top w3-large" style="z-index:3;width:250px;font-weight:bold;background-color:RGB(34, 45 , 50);" id="mySidebar"><br>
  ...
  <div class="element">
	...
	<a href="hangcomplaints.php" onclick="w3_close()" class="btn active" style="font-size:16px">عرض الشكوى التى تم التعامل معها<i class="fa fa-comments" aria-hidden="true"></i></a>
   ...
   }else
   {
	...
	if(count($rows)>0)
	{
		foreach($rows as $row)
		{
			...
			echo"<td><div class='form-group'><button type='submit' style='font-size:18px;font-weight:bold;' class='bs btn btn-success btn-block'>لم يتم التعامل <i class='fa fa-times' aria-hidden='true'></i></button></div></td>
	...
	{
		echo "<tr class=".$arr[0]."><td colspan='7'>جدول الشكاوى التى تم التعامل معها من هذا النوع فارغ</td><tr>";
	}
}
?>
